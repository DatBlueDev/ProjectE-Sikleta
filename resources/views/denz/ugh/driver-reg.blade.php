...
<head>
    ...
    <title>Driver Registration - eSikleta</title>
            ...
            <div class="row justify-content-center rounded-3 mt-1">
                <div class="col pt-5 mx-3"> 
                    <div class="card bg-light-subtle mb-5">
                        <h4 class="card-header">{{ ('Driver Registration') }}</h4>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                <label class="col-md-4 col-form-label text-md-end" for="drivers_license_image">{{ __('Upload License') }}</label>
                                <div class="col-md-6">
                                    <input type="file" class="form-control" id="drivers_license_image" name="drivers_license_image">
                                </div>
                            </div>
